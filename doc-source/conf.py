...
rst_prolog = f""".. |pkgname| replace:: flake8-helper
.. |pkgname2| replace:: ``flake8-helper``
.. |browse_github| replace:: `Browse the GitHub Repository <{github_url}>`__
"""

author = "Dominic Davis-Foster"
project = "flake8-helper".replace('_', '-')
...
documentation_summary = "A helper library for Flake8 plugins."
